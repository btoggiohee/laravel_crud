...
@section('content')
<form action="{{route('student.edit_finish',['id'=>$student->id])}}" method="post" class="form-horizontal">
    @csrf
    ...
    <div class="col-md-offset-3 text-center"><button class="btn btn-primary">編集</button></div>
</form>
@endsection